...
This experiment was created using PsychoPy3 Experiment Builder (v2020.1.2),
    on Wed 04 Nov 2020 03:11:46 PM CET
...
for thisTrial in trials:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if fix_cross.status == STARTED:
            ...
            if tThisFlipGlobal > fix_cross.tStartRefresh + 1.5-frameTolerance:
    ...
    trials.addData('box.started', box.tStartRefresh)
    trials.addData('box.stopped', box.tStopRefresh)
    # check responses
